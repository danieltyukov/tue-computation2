...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../counter_PS_REAL.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../counter_PS_REAL.srcs/sources_1/bd/design_1/ipshared/5bb9/hdl/verilog" \
       +incdir+"$ref_dir/../../../../counter_PS_REAL.srcs/sources_1/bd/design_1/ipshared/70fd/hdl" \
       +incdir+"../../../../counter_PS_REAL.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../counter_PS_REAL.srcs/sources_1/bd/design_1/ipshared/5bb9/hdl/verilog" \
       +incdir+"../../../../counter_PS_REAL.srcs/sources_1/bd/design_1/ipshared/70fd/hdl" \
       +incdir+"/opt/tools/Xilinx/Vivado/2018.2/data/xilinx_vip/include"
}
