...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set floor_0 [ create_bd_port -dir O -from 1 -to 0 floor_0 ]
  set mc_0 [ create_bd_port -dir I mc_0 ]
  set mc_1 [ create_bd_port -dir I mc_1 ]
  set movement_0 [ create_bd_port -dir O -from 1 -to 0 movement_0 ]
  set reset [ create_bd_port -dir I reset ]
  set update [ create_bd_port -dir I update ]

  # Create instance: ElevatorFSM_0, and set properties
  set ElevatorFSM_0 [ create_bd_cell -type ip -vlnv user.org:user:ElevatorFSM:1.0 ElevatorFSM_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ElevatorFSM_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net ElevatorFSM_0_floor [get_bd_ports floor_0] [get_bd_pins ElevatorFSM_0/floor]
  connect_bd_net -net ElevatorFSM_0_movement [get_bd_ports movement_0] [get_bd_pins ElevatorFSM_0/movement]
  connect_bd_net -net button_in_0_1 [get_bd_ports reset] [get_bd_pins debounce_0/button_in]
  connect_bd_net -net button_in_1_1 [get_bd_ports mc_0] [get_bd_pins debounce_1/button_in]
  connect_bd_net -net button_in_2_1 [get_bd_ports mc_1] [get_bd_pins debounce_2/button_in]
  connect_bd_net -net button_in_3_1 [get_bd_ports update] [get_bd_pins debounce_3/button_in]
  connect_bd_net -net debounce_0_button_out [get_bd_pins ElevatorFSM_0/reset] [get_bd_pins debounce_0/button_out]
  connect_bd_net -net debounce_1_button_out [get_bd_pins debounce_1/button_out] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net debounce_2_button_out [get_bd_pins debounce_2/button_out] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net debounce_3_button_out [get_bd_pins ElevatorFSM_0/update] [get_bd_pins debounce_3/button_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ElevatorFSM_0/s00_axi_aclk] [get_bd_pins debounce_0/clk] [get_bd_pins debounce_1/clk] [get_bd_pins debounce_2/clk] [get_bd_pins debounce_3/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ElevatorFSM_0/s00_axi_aresetn] [get_bd_pins debounce_0/reset] [get_bd_pins debounce_1/reset] [get_bd_pins debounce_2/reset] [get_bd_pins debounce_3/reset] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins ElevatorFSM_0/motor_control] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ElevatorFSM_0/S00_AXI/S00_AXI_reg] SEG_ElevatorFSM_0_S00_AXI_reg
