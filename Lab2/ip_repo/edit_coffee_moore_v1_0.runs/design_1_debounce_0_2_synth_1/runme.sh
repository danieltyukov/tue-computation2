...
HD_PWD='/media/sf_SharedWork/Lab2/ip_repo/edit_coffee_moore_v1_0.runs/design_1_debounce_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_debounce_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_debounce_0_2.tcl
