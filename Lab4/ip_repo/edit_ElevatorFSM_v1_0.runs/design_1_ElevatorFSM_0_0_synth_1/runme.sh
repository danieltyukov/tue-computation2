...
HD_PWD='/media/sf_SharedWork/Lab4/ip_repo/edit_ElevatorFSM_v1_0.runs/design_1_ElevatorFSM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ElevatorFSM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ElevatorFSM_0_0.tcl
