...
HD_PWD='/media/sf_SharedWork/mmips-vivado-base-2/vivado/project_1/project_1.runs/design_1_mMIPS_sim_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mMIPS_sim_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mMIPS_sim_0_0.tcl
