...
HD_PWD='/home/computation/counter_PS/counter_PS.runs/design_1_rst_sim_clk_gen_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_sim_clk_gen_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_sim_clk_gen_0_100M_0.tcl
