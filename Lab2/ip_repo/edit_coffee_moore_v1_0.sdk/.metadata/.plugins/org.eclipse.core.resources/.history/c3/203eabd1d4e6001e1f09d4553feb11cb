...
#define STATE_DISPLAY_OFFSET 0x0 // Adjust if necessary
#define COFFEE_OFFSET 0x4 // Adjust if necessary
#define INSERT_OFFSET 0x8 // Adjust if necessary
#define RESET_OFFSET 0xC // Adjust if necessary
#define COINS_OFFSET 0x10 // Adjust if necessary
