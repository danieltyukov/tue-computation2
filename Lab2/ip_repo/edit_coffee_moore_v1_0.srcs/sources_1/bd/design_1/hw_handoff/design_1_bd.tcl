...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net button_in_2_1 [get_bd_ports button_in_coins_5] [get_bd_pins debounce_2/button_in]
  connect_bd_net -net button_in_3_1 [get_bd_ports button_in_insert] [get_bd_pins debounce_3/button_in]
  ...
  connect_bd_net -net debounce_3_button_out [get_bd_pins coffee_moore_0/insert] [get_bd_pins debounce_3/button_out]
