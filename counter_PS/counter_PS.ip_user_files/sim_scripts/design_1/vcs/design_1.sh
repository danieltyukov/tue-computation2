...
#
# Generated by Vivado on Tue Mar 05 03:08:46 CET 2024
...
# Design libraries
design_libs=(xil_defaultlib xpm sim_clk_gen_v1_0_2 microblaze_v10_0_7 axi_lite_ipif_v3_0_4 mdm_v3_2_14 lib_cdc_v1_0_2 proc_sys_reset_v5_0_12 lmb_v10_v3_0_9 lmb_bram_if_cntlr_v4_0_15 blk_mem_gen_v8_4_1)
...
compile()
{
  ...
  vlogan -work sim_clk_gen_v1_0_2 $vlogan_opts +v2k \
    "$ref_dir/../../../../counter_PS.srcs/sources_1/bd/design_1/ipshared/d987/hdl/sim_clk_gen_v1_0_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work microblaze_v10_0_7 $vhdlan_opts \
    "$ref_dir/../../../../counter_PS.srcs/sources_1/bd/design_1/ipshared/b649/hdl/microblaze_v10_0_vh_rfs.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work axi_lite_ipif_v3_0_4 $vhdlan_opts \
    "$ref_dir/../../../../counter_PS.srcs/sources_1/bd/design_1/ipshared/cced/hdl/axi_lite_ipif_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a vhdlan.log

  vhdlan -work mdm_v3_2_14 $vhdlan_opts \
    "$ref_dir/../../../../counter_PS.srcs/sources_1/bd/design_1/ipshared/5125/hdl/mdm_v3_2_vh_rfs.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work lib_cdc_v1_0_2 $vhdlan_opts \
    "$ref_dir/../../../../counter_PS.srcs/sources_1/bd/design_1/ipshared/ef1e/hdl/lib_cdc_v1_0_rfs.vhd" \
  2>&1 | tee -a vhdlan.log

  vhdlan -work proc_sys_reset_v5_0_12 $vhdlan_opts \
    "$ref_dir/../../../../counter_PS.srcs/sources_1/bd/design_1/ipshared/f86a/hdl/proc_sys_reset_v5_0_vh_rfs.vhd" \
  2>&1 | tee -a vhdlan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/design_1/ip/design_1_rst_sim_clk_gen_0_100M_0/sim/design_1_rst_sim_clk_gen_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vhdlan -work lmb_v10_v3_0_9 $vhdlan_opts \
    "$ref_dir/../../../../counter_PS.srcs/sources_1/bd/design_1/ipshared/78eb/hdl/lmb_v10_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work lmb_bram_if_cntlr_v4_0_15 $vhdlan_opts \
    "$ref_dir/../../../../counter_PS.srcs/sources_1/bd/design_1/ipshared/92fd/hdl/lmb_bram_if_cntlr_v4_0_vh_rfs.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work blk_mem_gen_v8_4_1 $vlogan_opts +v2k \
    "$ref_dir/../../../../counter_PS.srcs/sources_1/bd/design_1/ipshared/67d8/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/media/sf_SharedWork/counter_PS/counter_PS.cache/compile_simlib/vcs"
  fi
