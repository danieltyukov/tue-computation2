...
#define AXI_GPIO_BASEADDR XPAR_COFFEE_MEALY_0_S00_AXI_BASEADDR // Adjust this to your AXI GPIO base address
#define STATE_DISPLAY_OFFSET COFFEE_MEALY_S00_AXI_SLV_REG3_OFFSET // Adjust if necessary
#define COFFEE_OFFSET COFFEE_MEALY_S00_AXI_SLV_REG2_OFFSET // Adjust if necessary
#define INSERT_OFFSET COFFEE_MEALY_S00_AXI_SLV_REG1_OFFSET // Adjust if necessary
#define RESET_OFFSET COFFEE_MEALY_S00_AXI_SLV_REG0_OFFSET // Adjust if necessary
#define COINS_OFFSET COFFEE_MEALY_S00_AXI_SLV_REG1_OFFSET // Adjust if necessary
