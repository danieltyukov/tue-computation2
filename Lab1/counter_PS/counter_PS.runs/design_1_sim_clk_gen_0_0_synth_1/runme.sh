...
HD_PWD='/media/sf_SharedWork/counter_PS/counter_PS.runs/design_1_sim_clk_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_sim_clk_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_sim_clk_gen_0_0.tcl
